...
class MainWindow(Frame):
    ...
    def __init__(self, app):
        ...
        num_7 = Button(frame, text="7", font=butt_font, command=lambda: self.pressed("7"), bg=num_bg, activebackground=active_bg)
        num_8 = Button(frame, text="8", font=butt_font, command=lambda: self.pressed("8"), bg=num_bg, activebackground=active_bg)
        num_9 = Button(frame, text="9", font=butt_font, command=lambda: self.pressed("9"), bg=num_bg, activebackground=active_bg)

        num_4 = Button(frame, text="4", font=butt_font, command=lambda: self.pressed("4"), bg=num_bg, activebackground=active_bg)
        num_5 = Button(frame, text="5", font=butt_font, command=lambda: self.pressed("5"), bg=num_bg, activebackground=active_bg)
        num_6 = Button(frame, text="6", font=butt_font, command=lambda: self.pressed("6"), bg=num_bg, activebackground=active_bg)

        num_1 = Button(frame, text="1", font=butt_font, command=lambda: self.pressed("1"), bg=num_bg, activebackground=active_bg)
        num_2 = Button(frame, text="2", font=butt_font, command=lambda: self.pressed("2"), bg=num_bg, activebackground=active_bg)
        num_3 = Button(frame, text="3", font=butt_font, command=lambda: self.pressed("3"), bg=num_bg, activebackground=active_bg)

        num_0 = Button(frame, text="0", font=butt_font, command=lambda: self.pressed("0"), bg=num_bg, activebackground=active_bg)
        ...
        plus = Button(frame, text="+", font=butt_font, command=lambda: self.pressed("+"),bg=op_bg, fg="blue", activebackground=active_bg, activeforeground="blue")
        minus = Button(frame, text="-", font=butt_font, command=lambda: self.pressed("-"),bg=op_bg, fg="blue", activebackground=active_bg, activeforeground="blue")
        divide = Button(frame, text="/", font=butt_font, command=lambda: self.pressed("/"),bg=op_bg, fg="blue", activebackground=active_bg, activeforeground="blue")
        multiply = Button(frame, text="*", font=butt_font, command=lambda: self.pressed("*"),bg=op_bg, fg="blue", activebackground=active_bg, activeforeground="blue")
        equal = Button(frame, text="=", font=butt_font, command=lambda: self.equalpressed(),bg=op_bg, fg="green", activebackground=active_bg, activeforeground="green")

        clear = Button(frame, text="C", font=butt_font, command=lambda: self.clear_entry(),bg=op_bg, fg="red", activebackground=active_bg, activeforeground="red")
        del_last_num = Button(frame, text="CE", font=("Verdana", 9, "bold"), command=lambda: self.delete_last(), width=7,bg=op_bg, fg="red", activebackground=active_bg, activeforeground="red" )
        ...
        more = Button(frame, text="Viac", font=("Verdana", 10), command=lambda: self.show_more(), bg=op_bg, fg="blue", activebackground=active_bg, activeforeground="blue")
